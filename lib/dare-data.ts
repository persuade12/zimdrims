...
export const navGroups: NavGroup[] = [
  {
    items: [
      ...
      { label: 'Platform Overview', icon: LayoutGrid, href: '/ops/platform-overview' },
    ],
  },
  {
    title: 'Administrative Enablement',
    items: [
      { label: 'Digital Administrative Enabler', icon: Briefcase, href: '/ops/admin-enabler' },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: '/ops/leaders',
        children: [
          { label: 'Chiefs', icon: Crown, href: '/ops/leaders/chiefs' },
          { label: 'Headmen', icon: UserRound, href: '/ops/leaders/headmen' },
          { label: 'Village Heads', icon: Users, href: '/ops/leaders/village-heads' },
        ],
      },
    ],
  },
  {
    title: 'Data & Profiles',
    items: [
      { label: 'Household Profiles', icon: Users, href: '/ops/households' },
      { label: 'Community Profiles', icon: Building2, href: '/ops/communities' },
      { label: 'Traditional Court', icon: Gavel, href: '/ops/courts' },
      { label: 'ZimVAC Dashboards', icon: BarChart3, href: '/ops/zimvac' },
      { label: 'ZimLAC Dashboards', icon: Landmark, href: '/ops/zimlac' },
      { label: 'District & Provincial Profiles', icon: Map, href: '/ops/profiles/districts' },
    ],
  },
  {
    title: 'Services & Management',
    items: [
      { label: 'Development Projects', icon: HardHat, href: '/ops/projects' },
      { label: 'Hazard & Risk Intelligence', icon: ShieldAlert, href: '/ops/hazards' },
      { label: 'Environment & Climate', icon: Leaf, href: '/ops/environment' },
      { label: 'Social Protection', icon: HeartHandshake, href: '/ops/social-protection' },
      { label: 'Health', icon: HeartPulse, href: '/ops/health' },
      { label: 'Education', icon: GraduationCap, href: '/ops/education' },
      { label: 'Infrastructure & Services', icon: Route, href: '/ops/infrastructure' },
    ],
  },
  {
    title: 'Reports & Insights',
    items: [
      { label: 'Reports & Analytics', icon: FileBarChart, href: '/ops/reports' },
      {
        label: 'Indigenous Knowledge Systems (IKS)',
        icon: BookOpen,
        href: '/ops/iks',
        children: [
          { label: 'Environment & Climate Change', icon: Leaf, href: '/ops/iks/environment-climate-change' },
          { label: 'Agriculture', icon: Wheat, href: '/ops/iks/agriculture' },
          { label: 'Cultural Heritage', icon: Landmark, href: '/ops/iks/cultural-heritage' },
        ],
      },
      { label: 'AI Insights & Alerts', icon: Sparkles, href: '/ops/ai-insights' },
      { label: 'Data Marketplace', icon: Store, href: '/ops/marketplace' },
      { label: 'Governance Insights', icon: ScrollText, href: '/ops/governance-insights' },
    ],
  },
]
